...
app.use(express.json({limit:"16kb"}) )   //keeping a limit for accepting jsons.as we wont accept any no.of jsons and crash out application.
app.use(express.urlencoded({extended:true,limit:"16kb"}))    //in order to configure url .eg:in google you can see saketh kumar in search bar is converted into saketh+kumar or some %20 in url.
